...
app.get("/", async function(req, res){
    ...
    let apiUrl = `https://api.unsplash.com/photos/random/?client_id=mq5BtoJumRheJGtMDTIeNouIBrTdjnMy85oATloKmqA&featured=true`;
...
app.get("/search", async function(req, res){
    ...
    let apiUrl = `https://api.unsplash.com/photos/random/?count=9&client_id=mq5BtoJumRheJGtMDTIeNouIBrTdjnMy85oATloKmqA&featured=true&orientation=landscape&query=${keyword}`;
    let response = await fetch(apiUrl);
    let data = await response.json();
